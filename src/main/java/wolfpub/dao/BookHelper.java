...
import main.java.wolfpub.dbobject.Book;
import main.java.wolfpub.dbobject.Issue;
...
public class BookHelper {
                        ...
                        while(updatechoice!=6){
                            ...
                            switch (updatechoice){
                                ...
                                case 5:
                                    ...
                                    break;
                                case 6: break;
                                default: System.out.println("Invalid option entered! Please enter a valid option.\n");
                            }
                        }
    ...
    public static void paymentEditorAuthor()
    {
        Scanner scanner = new Scanner(System.in);
        System.out.println("\n Welcome to the WolfPub. Please enter the following details.");
        System.out.println("\nPublication ID: ");
